...
menu1.addItems([ 
	{caption: "Home", url: "index.jsp?p=home"},
	{caption: "NoidaMap", url: "index.jsp?p=map"},	
	{caption: "classifieds", subitems: [
		
	{caption: "post classified",  url: "index.jsp?p=newAd", icon: "images/list_ico.gif"},
	{caption: "view classifieds",  url: "index.jsp?p=viewAds", icon: "images/add_ico.gif"},
    ]},
	{caption: "Financial Institutions", subitems: [
		
	{caption: "Bank",  url: "index.jsp?p=noidaInfo&category=bank", icon: "images/list_ico.gif"},
	{caption: "ATM",  url: "index.jsp?p=noidaInfo&category=atm", icon: "images/add_ico.gif"},
    ]},
	{caption: "Entertainment", subitems: [
	{caption: "Markets",  url: "index.jsp?p=noidaInfo&category=market", icon: "images/list_ico.gif"},
	{caption: "Shopping Malls",  url: "index.jsp?p=noidaInfo&category=malls", icon: "images/add_ico.gif"},
	{caption: "Pubs",  url: "index.jsp?p=noidaInfo&category=pubs", icon: "images/list_ico.gif"},
	]},
	{caption: "Education and IT", subitems: [
	{caption: "IT Companies",  url: "index.jsp?p=noidaInfo&category=IT Company", icon: "images/list_ico.gif"},
	{caption: "Colleges & Universities",  url: "index.jsp?p=noidaInfo&category=college", icon: "images/list_ico.gif"},
	{caption: "Book shops",  url: "index.jsp?p=noidaInfo&category=book shops", icon: "images/add_ico.gif"},
	]},
	{caption: "Utilities", subitems: [
		
	{caption: "Hospitals",  url: "index.jsp?p=noidaInfo&category=hospitals", icon: "images/list_ico.gif"},
	{caption: "Police Station",  url: "index.jsp?p=noidaInfo&category=police station", icon: "images/add_ico.gif"},
	{caption: "Tour and Travels",  url: "index.jsp?p=noidaInfo&category=tour", icon: "images/list_ico.gif"},
	{caption: "Transportation",  url: "index.jsp?p=noidaInfo&category=transportation", icon: "images/add_ico.gif"},
	
	]},
	{caption: "Register", url: "index.jsp?p=register"},
	{caption: "Login", url: "index.jsp?p=login"},
